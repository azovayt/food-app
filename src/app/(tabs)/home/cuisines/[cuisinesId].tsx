// src/app/(tabs)/home/cuisines/[cuisinesId].tsx
import {
  View,
  Text,
  Image,
...
const CuisinesDetailsScreen = () => {
  ...
  const [isHoursOpen, setIsHoursOpen] = useState(false); // Dropdown için state
  ...
  // CartContext'ten fonksiyonları al
  ...
  // Sepete ekle fonksiyonu (artık context ile)
  const handleAddToCart = (item: any) => {
    ...
    router.push("/(tabs)/cart"); // Sepete yönlendir
  };
...
export default CuisinesDetailsScreen;
